...
{# Museu em Fios — home no conceito V1 "editorial claro" (aprovado pelo cliente):
   hero da obra + marquee da endline + manifesto (com o vídeo institucional em
   destaque) abrem a página; as seções nativas (destaques, categorias, vídeo,
   instafeed…) seguem configuráveis em Layout → Personalizar; a experiência
   (passos) e o conteúdo do kit fecham. #}
