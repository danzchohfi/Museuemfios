				...
				<div class="swiper-wrapper">
					{% for media in product.media %}
						{% if media.isImage %}
							...
							{% else %}
								<a href="{{ media | product_image_url('original') }}" data-fancybox="product-gallery" class="js-product-slide-link product-slide-link" style="padding-bottom: {{ media.dimensions['height'] / media.dimensions['width'] * 100 }}%;">
								{% endif %}
